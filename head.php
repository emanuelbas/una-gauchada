...
<?php 
	...
	if ((isset($_SESSION['email']))){ 
		...
		if ($row['IsAdministrador']==1){
			echo "<li><a href='mostrar_ranking.php'> Ver tabla de puntuaciones<a></li>"."<li><a href='ventana_categorias.php'> Configurar categorias<a></li>"."<li><a href='mostrar_recaudaciones.php'> Ver recaudaciones<a></li>"."<li><a href='alta_reputacion_pantalla.php'> Configurar reputaciones<a></li>".'<li><a href="cerrar_sesion.php">Cerrar sesion</a></li> &nbsp;';
		} else {
